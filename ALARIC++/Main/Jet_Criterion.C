...
namespace ALARIC {
  ...
  };// end of class ALARIC_Jet_Criterion

}// end of namespace ALARIC

DECLARE_GETTER(ALARIC::Jet_Criterion,"Alaric",Jet_Criterion,JetCriterion_Key);

Jet_Criterion *Getter<Jet_Criterion,JetCriterion_Key,ALARIC::Jet_Criterion>::
operator()(const JetCriterion_Key &args) const
{
  return new ALARIC::Jet_Criterion(args);
}

void Getter<Jet_Criterion,JetCriterion_Key,ALARIC::Jet_Criterion>::
PrintInfo(std::ostream &str,const size_t width) const
{ 
  str<<"The ALARIC jet criterion";
}
