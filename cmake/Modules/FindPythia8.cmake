...
if (PYTHIA8_SEARCH_DIRS)
  ...
  find_path(PYTHIA8_XMLDOC_DIR Version.xml PATHS ${PYTHIA8_SEARCH_DIRS} PATH_SUFFIXES xmldoc  share/Pythia8/xmldoc share/pythia8-data/xmldoc  share/doc/packages/pythia/xmldoc NO_DEFAULT_PATH)
  ...
  find_path(PYTHIA8_INCLUDE_DIR Pythia.h Pythia8/Pythia.h PATHS ${PYTHIA8_SEARCH_DIRS} PATH_SUFFIXES include)
  find_path(PYTHIA8_XMLDOC_DIR Version.xml PATHS ${PYTHIA8_SEARCH_DIRS} PATH_SUFFIXES xmldoc  share/Pythia8/xmldoc share/pythia8-data/xmldoc  share/doc/packages/pythia/xmldoc)
  find_library(PYTHIA8_LIBRARY NAMES pythia8 Pythia8 PATHS ${PYTHIA8_SEARCH_DIRS} PATH_SUFFIXES lib lib64)
  find_library(PYTHIA8_lhapdfdummy_LIBRARY NAMES lhapdfdummy PATHS ${PYTHIA8_SEARCH_DIRS} PATH_SUFFIXES lib lib64)
endif()
