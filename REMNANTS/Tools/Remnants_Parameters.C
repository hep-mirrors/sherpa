...
void Remnants_Parameters::SetNucleonDefaults()
{
  ...
  parmsP->params["MATTER_RADIUS_1"]         = 0.845;
  parmsP->params["MATTER_RADIUS_2"]         = 1.00;
  parmsP->params["MATTER_FRACTION_1"]       = 0.658;
  parmsP->param_variations["MATTER_RADIUS_1"]   = {0.845};
  parmsP->param_variations["MATTER_RADIUS_2"]   = {1.00};
  parmsP->param_variations["MATTER_FRACTION_1"] = {0.658};
