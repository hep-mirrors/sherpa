...
Remnant_Handler::Remnant_Handler(PDF::ISR_Handler* isr, BEAM::Beam_Spectra_Handler* beam_handler,
...
void Remnant_Handler::InitializeRemnants(PDF::ISR_Handler* isr, BEAM::Beam_Spectra_Handler* beam)
{
                                                  ...
                                                  const bool& isrescatter)
{
  ...
  if (!m_kinematics.FillBlobs(bloblist) || !CheckBeamBreakup() ||
