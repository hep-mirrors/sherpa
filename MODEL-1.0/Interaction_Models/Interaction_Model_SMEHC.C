...
void Interaction_Model_SMEHC::c_FFS(std::vector<Single_Vertex>& vertex,int& vanz) {p_moew->c_FFS(vertex,vanz);}
...
void Interaction_Model_SMEHC::c_SSS(std::vector<Single_Vertex>& vertex,int& vanz) {p_moew->c_SSS(vertex,vanz);}

void Interaction_Model_SMEHC::c_SSSS(std::vector<Single_Vertex>& vertex,int& vanz) { p_moew->c_SSSS(vertex,vanz); }
void Interaction_Model_SMEHC::c_SSVV(std::vector<Single_Vertex>& vertex,int& vanz) { p_moew->c_SSVV(vertex,vanz); }
