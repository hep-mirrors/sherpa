...
C--Translation from HDECAY
      ...
      mw = AMW
      gf = GF0
      alphasmz = ALPHAS_HDEC(AMZ,2)
      as = ALPHAS_HDEC(AMT,2)
      sps = 0
      lhbms = 0
      selec5 = 1
      selec6 = 1
...
C**************************************************************
C
      COMPLEX FUNCTION CSCAL*16(S,MF,M1,M2,M3)
C
C  S = MOMENTUM TRANSFER; M1,M2,M3  ARE THE INTERNAL MASSES
C
      IMPLICIT REAL*8 (A-Y)
...
C ================================================================
C
      COMPLEX FUNCTION CSPENU*16(X,SIG)
C
      IMPLICIT REAL*8(A-Y)
...
C*******************************************************************
C
c$$$      COMPLEX FUNCTION CSPEN*16(X,SIG)
