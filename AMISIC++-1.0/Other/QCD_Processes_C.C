...
QCD_Processes_C::QCD_Processes_C(PDF::ISR_Handler * _isr,BEAM::Beam_Spectra_Handler * _beam,
...
void QCD_Processes_C::FillMode(Mode mode) 
{
  XS_Group *group;
  switch (mode) {
  case All:
  ...
  case q1q1bq2q2b:
    ...
    break;
  case Unknown:
    ATOOLS::msg.Error()<<"QCD_Processes_C::FillMode("<<mode<<"): No mode specified! Abort."<<std::endl;
  case None:
    break;
  }
}

void QCD_Processes_C::CreateFSRChannels() 
{
