...
std::ostream & SINIC::operator<<(std::ostream & s, const T_Prop & tprop) {
  s<<" | ["<<tprop.m_col<<"] for "
...
std::ostream & SINIC::operator<<(std::ostream & s, const TPropList & props) {
