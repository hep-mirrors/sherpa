...
/*   }; */
  ...
  /*   std::set<std::string,ATOOLS::String_Sort> m_contextevents; */
  /*   std::set<std::string,ATOOLS::String_Sort> m_contextinfo; */
  /*   std::set<std::string,ATOOLS::String_Sort> m_contexttracking; */
  /*   std::set<std::string,ATOOLS::String_Sort> m_contextdebugging; */
  /*   std::set<std::string,ATOOLS::String_Sort> m_contextiodebugging; */
  ...
  public:
    ...
    /* inline const std::set<std::string,ATOOLS::String_Sort>& ContextEvents() { */
    /*   return m_contextevents; */
    /* } */
    /* inline const std::set<std::string,ATOOLS::String_Sort>& ContextInfo() { */
    /*   return m_contextinfo; */
    /* } */
    /* inline const std::set<std::string,ATOOLS::String_Sort>& ContextTracking() { */
    /*   return m_contexttracking; */
    /* } */
    /* inline const std::set<std::string,ATOOLS::String_Sort>& ContextDebugging() { */
    /*   return m_contextdebugging; */
    /* } */
    /* inline const std::set<std::string,ATOOLS::String_Sort>& ContextIODebugging() { */
