...
std::map<std::string,unsigned long int> Return_Value::s_warning_counter;
std::map<std::string,unsigned long int> Return_Value::s_error_counter;
std::map<std::string,unsigned long int> Return_Value::s_retry_method_counter;
std::map<std::string,unsigned long int> Return_Value::s_retry_phase_counter;
unsigned long int                       Return_Value::s_retry_event_counter;
Return_Value rvalue;

void Return_Value::Statistics()
{
  msg.Out()<<METHOD<<": Return value statistics: "<<endl<<endl
	   <<"   Retry events: "<<s_retry_event_counter<<endl;
...
void Return_Value::IncWarnings(std::string name) {
...
void Return_Value::IncRetryEvent(std::string name){ s_retry_event_counter++; }
