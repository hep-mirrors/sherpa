...
void ATOOLS::Return_Value::Statistics()
{
...
void ATOOLS::Return_Value::IncRetryPhase(std::string name) {
...
void ATOOLS::Return_Value::IncRetryEvent(std::string name) {
