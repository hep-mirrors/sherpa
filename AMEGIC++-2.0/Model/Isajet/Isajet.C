...
void Isajet::Chargino(Matrix<2> &Zplus,Matrix<2> &Zminus)
{
  ...
  Flavour flav;
  flav = Flavour(kf::Chargino1);flav.set_mass(dabs(MChi1));
  if (MChi1<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::Chargino2);flav.set_mass(dabs(MChi2));
  if (MChi2<0) flav.set_mass_sign(-1);

  msg.Tracking()<<"--------------------------------------------------------------"<<std::endl;
  msg.Tracking()<<"Charginomasses :"<<std::endl;
  msg.Tracking()<<"m_Chi_1 = "<<Flavour(kf::Chargino1).mass()<<" Sign: "<<Flavour(kf::Chargino1).get_mass_sign();
  msg.Tracking()<<", m_Chi_2 = "<<Flavour(kf::Chargino2).mass()<<" Sign: "<<Flavour(kf::Chargino2).get_mass_sign()<<std::endl;
...
void Isajet::Neutralino(Matrix<4> &ZN)
{
  ...
  Flavour flav;
  flav = Flavour(kf::Neutralino1);flav.set_mass(dabs(M[0]));
  if (M[0]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::Neutralino2);flav.set_mass(dabs(M[1]));
  if (M[1]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::Neutralino3);flav.set_mass(dabs(M[2]));
  if (M[2]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::Neutralino4);flav.set_mass(dabs(M[3]));
  if (M[3]<0) flav.set_mass_sign(-1);
  ...
  msg.Tracking()<<", ms_Neu_2 = "<<Flavour(kf::Neutralino2).get_mass_sign()<<std::endl;
  msg.Tracking()<<"ms_Neu_3 = "<<Flavour(kf::Neutralino3).get_mass_sign();
  msg.Tracking()<<", ms_Neu_4 = "<<Flavour(kf::Neutralino4).get_mass_sign()<<std::endl;
...
void Isajet::sNeutrino(Matrix<3> &ZNue)
{
  ...
  Flavour flav;    
  flav = Flavour(kf::sNu1);flav.set_mass(dabs(mn1));
  if (mn1<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sNu2);flav.set_mass(dabs(mn2));
  if (mn2<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sNu3);flav.set_mass(dabs(mn3));
  if (mn3<0) flav.set_mass_sign(-1);
...
void Isajet::Higgs(Matrix<2> &ZR,Matrix<2> & ZH,double& _v)
{
  ...
  Flavour flav;
  flav = Flavour(kf::h0);flav.set_mass(mh);
  flav = Flavour(kf::H0);flav.set_mass(mH);
  flav = Flavour(kf::A0);flav.set_mass(mA);
  flav = Flavour(kf::Hmin);flav.set_mass(mHC);
...
void Isajet::sUps(Matrix<6> &Zu,double &mu,Matrix<3> &ws,Matrix<3> &us)
{
  ...
  flav = Flavour(kf::sUpL);flav.set_mass(dabs(msups[0]));
  if (msups[0]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sCharmL);flav.set_mass(dabs(msups[1]));
  if (msups[1]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sTopL);flav.set_mass(dabs(msups[2]));
  if (msups[2]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sUpR);flav.set_mass(dabs(msups[3]));
  if (msups[3]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sCharmR);flav.set_mass(dabs(msups[4]));
  if (msups[4]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sTopR);flav.set_mass(dabs(msups[5]));
  if (msups[5]<0) flav.set_mass_sign(-1);
...
void Isajet::sDowns(Matrix<6> &Zd,Matrix<3> &es,Matrix<3> &ds)
{
  ...
  flav = Flavour(kf::sDownL);flav.set_mass(dabs(msdowns[0]));
  if (msdowns[0]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sStrangeL);flav.set_mass(dabs(msdowns[1]));
  if (msdowns[1]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sBottomL);flav.set_mass(dabs(msdowns[2]));
  if (msdowns[2]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sDownR);flav.set_mass(dabs(msdowns[3]));
  if (msdowns[3]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sStrangeR);flav.set_mass(dabs(msdowns[4]));
  if (msdowns[4]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sBottomR);flav.set_mass(dabs(msdowns[5]));
  if (msdowns[5]<0) flav.set_mass_sign(-1);
...
void Isajet::sLeptons(Matrix<6> &Zl,double &mu,Matrix<3> &ls,Matrix<3> &ks)
{
  ...
  flav = Flavour(kf::sElectronL);flav.set_mass(dabs(msleptons[0]));
  if (msleptons[0]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sMuL);flav.set_mass(dabs(msleptons[1]));
  if (msleptons[1]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sTauL);flav.set_mass(dabs(msleptons[2]));
  if (msleptons[2]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sElectronR);flav.set_mass(dabs(msleptons[3]));
  if (msleptons[3]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sMuR);flav.set_mass(dabs(msleptons[4]));
  if (msleptons[4]<0) flav.set_mass_sign(-1);
  flav = Flavour(kf::sTauR);flav.set_mass(dabs(msleptons[5]));
  if (msleptons[5]<0) flav.set_mass_sign(-1);
...
void Isajet::Gluino(double &m_GL)
{
  ...
  flav = Flavour(kf::Gluino);flav.set_mass(dabs(mGL));
  if (mGL<0) flav.set_mass_sign(-1);
