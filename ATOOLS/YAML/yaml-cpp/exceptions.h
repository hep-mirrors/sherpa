#ifndef ATOOLS_YAML_EXCEPTIONS_H_62B23520_7C8E_11DE_8A39_0800200C9A66
#define ATOOLS_YAML_EXCEPTIONS_H_62B23520_7C8E_11DE_8A39_0800200C9A66
...
#include "ATOOLS/YAML/yaml-cpp/noexcept.h"
#include "ATOOLS/YAML/yaml-cpp/traits.h"
#include <sstream>
#include <stdexcept>
#include <string>
...
class YAML_CPP_API Exception : public std::runtime_error {
 ...
 private:
  static const std::string build_what(const Mark& mark,
    ...
    output << "ATOOLS/YAML/yaml-cpp: error at line " << mark.line + 1 << ", column "
           << mark.column + 1 << ": " << msg;
    return output.str();
  }
};
...
#endif  // ATOOLS_YAML_EXCEPTIONS_H_62B23520_7C8E_11DE_8A39_0800200C9A66
