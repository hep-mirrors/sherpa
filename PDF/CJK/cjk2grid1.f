...
*********************************************************************
      ...
      SUBROUTINE GRIDV2(IOPT,XIN,XCIN,XBIN,Q2IN,
...
*********************************************************************
     ...
     % hqx(0:8,0:NQ2+1,24),hqh(4,4),x(4),per(7),
     % xdatah(0:107)
      common /ISTV2/ IST
...
*****************************************************************
      ...
      if (bord.EQ.1) then
         ...
         y12(1) = d2fv2(x1(1),x1(3),x2(1),x2(3),
     %                yg(1,1),yg(1,3),yg(3,1),yg(3,3))
         y12(2) = d2fv2(x1(2),x1(4),x2(1),x2(3),
     %                yg(2,1),yg(2,3),yg(4,1),yg(4,3))
         y12(3) = d2fv2(x1(2),x1(4),x2(2),x2(4),
     %                yg(2,2),yg(2,4),yg(4,2),yg(4,4))
         y12(4) = d2fv2(x1(1),x1(3),x2(2),x2(4),
     %                yg(1,2),yg(1,4),yg(3,2),yg(3,4))
         ...
         y12(1) = d2fv2(x1(2),x1(3),x2(2),x2(3),
