...
void Simple_Pole_Uniform::GeneratePoint(Info_Key &spkey,Info_Key &ykey,const double *rans,const int mode) 
{
...
void Simple_Pole_Forward::GeneratePoint(Info_Key &spkey,Info_Key &ykey,const double *rans,const int mode) 
{
  CalculateLimits(spkey,ykey);
...
void Simple_Pole_Backward::GeneratePoint(Info_Key &spkey,Info_Key &ykey,const double *rans,int mode)
{
  CalculateLimits(spkey,ykey);
  m_spkey[3]=CE.MasslessPropMomenta(m_sexponent,m_spkey[0],m_spkey[1],rans[0]);
...
void Simple_Pole_Central::GeneratePoint(Info_Key &spkey,Info_Key &ykey,const double *rans,int mode)
{
  CalculateLimits(spkey,ykey);
  m_spkey[3]=CE.MasslessPropMomenta(m_exponent,m_spkey[0],m_spkey[1],rans[0]);
