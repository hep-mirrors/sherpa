...
void C3_2::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p1_3 = p[1]-p[3];
  CE.TChannelMomenta(p[0],p1_3,p[2],p[4],s2,s4,0.,m_alpha,1.,-1.,m_amct,0,ran[3],ran[4]);
}
...
void C3_2::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  if (m_kTC_0__1_3_2_4.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_3_2_4<<CE.TChannelWeight(p[0],p1_3,p[2],p[4],0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_3_2_4[0],m_kTC_0__1_3_2_4[1]);
  wt *= m_kTC_0__1_3_2_4.Weight();

  rans[3]= m_kTC_0__1_3_2_4[0];
  rans[4]= m_kTC_0__1_3_2_4[1];
