...
void C3_8::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  CE.TChannelMomenta(p[0],p[1],p[4],p23,s4,s23,0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,ran[1-(size_t)m_onshell],ran[2-(size_t)m_onshell]);
...
void C3_8::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  rans[1-(size_t)m_onshell]= m_kTC_0__1__4_23[0];
  rans[2-(size_t)m_onshell]= m_kTC_0__1__4_23[1];
