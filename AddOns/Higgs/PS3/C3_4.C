...
namespace PHASIC {
  class C3_4 : public Single_Channel {
    ...
    Vegas* p_vegas;
  public:
    C3_4(int,int,Flavour*,Integration_Info * const);
    ~C3_4();
...
extern "C" Single_Channel * Getter_C3_4(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C3_4(nin,nout,fl,info);
}

void C3_4::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
...
void C3_4::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  rans[3]= m_kTC_0__1_2_3_4[0];
  rans[4]= m_kTC_0__1_2_3_4[1];
...
C3_4::C3_4(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C3_4");
  rannum = 5;
  ...
  m_ctmax = 1.;
  m_ctmin = -1.;
  m_kTC_0__1_2_3_4.Assign(std::string("TC_0__1_2_3_4"),2,0,info);
...
void C3_4::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 0;
  width = 0.;
...
void C3_4::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C3_4::ChID()
{
  return std::string("CGND$MTH_34$TC_0__1_2_3_4$TC_0__1__34_2$ZS_0$");
}
