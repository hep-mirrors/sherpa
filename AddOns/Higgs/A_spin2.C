...
Complex qqXgamgam_gen(int i1, int h1, int i2, int h2, int i3, int h3, int i4, int h4) {
  if ( h1==h2 || h3==h4 ) return 0;
  else if ( h1==h3 ) {
     if ( h1==1 ) return qqXgamgam_mpmp(i2,i1,i4,i3);
     else return qqXgamgam_mpmp(i1,i2,i3,i4);
  }
  else { // h1==h4
     if ( h1==1 ) return qqXgamgam_mpmp(i2,i1,i3,i4);
...
Complex qqgXgamgam_gen(int i1, int h1, int i2, int i3, int h3, int i4, int h4, int i5, int h5) {
  ...
  if ( h4==1 ) {
    if ( h1==1 ) {
      if ( h3==1 ) return qqgXgamgam_mppmp(i2,i1,i3,i5,i4);
      else return qqgXgamgam_pmmpm(i1,i2,i3,i4,i5);
    }
    else { // h1==-1
      if ( h3==-1 ) return qqgXgamgam_pmmpm(i2,i1,i3,i4,i5);
      else return qqgXgamgam_mppmp(i1,i2,i3,i5,i4);
    }
  }
  else { // h4==-1
    if ( h1==1 ) {
      if ( h3==1 ) return qqgXgamgam_mppmp(i2,i1,i3,i4,i5);
      else return qqgXgamgam_pmmpm(i1,i2,i3,i5,i4);
    }
    else { // h1==-1
      if ( h3==-1 ) return qqgXgamgam_pmmpm(i2,i1,i3,i5,i4);
...
Complex qqbXgamgam(int h1, int h2, int h3, int h4){ return qqXgamgam_gen(1,h1,2,h2,3,h3,4,h4); }

// qbar(1) q(2) -> gam(3) gam(4):
Complex qbqXgamgam(int h1, int h2, int h3, int h4){ return qqXgamgam_gen(2,h2,1,h1,3,h3,4,h4); }
