    ...
    Output_Base("HepMC3")
{
    ...
    {
    case 0:
        p_writer = get_output_file<HepMC3::WriterAscii>(m_outstream, m_compression, precision, m_basename, m_ext);
        break;
    case 1:
        p_writer = get_output_file<HepMC3::WriterHEPEVT>(m_outstream, m_compression, precision, m_basename, m_ext);
        break;
    case 2:
        p_writer = get_output_file<HepMC3::WriterAsciiHepMC2>(m_outstream, m_compression, precision, m_basename, m_ext);
        break;
    case 3:
#ifdef USING__HEPMC3__ROOT
