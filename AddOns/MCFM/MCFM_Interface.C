...
namespace SHERPA {
  ...
  public:
	...
	Copy(MCFM_PATH+std::string("/share/process.DAT"),pdname);
      ...
      params["charm_yukawa"]=ToString(Flavour(kf_c).Yuk(),16);
      params["bottom_yukawa"]=ToString(Flavour(kf_b).Yuk(),16);
      params["top_yukawa"]=ToString(Flavour(kf_t).Yuk(),16);
      params["tau_yukawa"]=ToString(Flavour(kf_tau).Yuk(),16);
      params["ew_scheme"]="5";
