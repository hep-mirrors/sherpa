...
namespace SHERPA {
  ...
  class Output_HDF5_v1 : public Output_Base {
  ...
  public:
    ...
    Output_HDF5_v1(const Output_Arguments &args):
  ...
  };// end of class Output_HDF5_v1

}// end of namespace SHERPA

DECLARE_GETTER(Output_HDF5_v1,"HDF5v1",
	       Output_Base,Output_Arguments);

Output_Base *ATOOLS::Getter<Output_Base,Output_Arguments,Output_HDF5_v1>::
operator()(const Output_Arguments &args) const
{
  return new Output_HDF5_v1(args);
}

void ATOOLS::Getter<Output_Base,Output_Arguments,Output_HDF5_v1>::
PrintInfo(std::ostream &str,const size_t width) const
{
  str<<"HDF5 output (version 1)";
}
