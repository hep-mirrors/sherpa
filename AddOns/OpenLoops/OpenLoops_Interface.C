                                     ...
                                     PDF::ISR_Handler *const isr)
{
  ...
  helpd = s["AMEGIC_TCHANNEL_ALPHA"].SetDefault(0.9).Get<double>();
  rpa->gen.SetVariable("AMEGIC_TCHANNEL_ALPHA",ToString(helpd));
  helpd = s["AMEGIC_CHANNEL_EPSILON"].SetDefault(0.0).Get<double>();
  rpa->gen.SetVariable("AMEGIC_CHANNEL_EPSILON",ToString(helpd));
  helpd = s["AMEGIC_THRESHOLD_EPSILON"].SetDefault(1.5).Get<double>();
