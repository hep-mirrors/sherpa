...
*/
HELICITIES::DivArrC
HELICITIES::PV_Triangle_10(const double&  p12, const double&  p22, const double&  s12,
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_11(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  if (IsZero(s12)) {
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_12(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_20(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  if (!IsZero(s12) || !IsEqual(p12,p22) || !IsEqual(m12,m22)) {
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_21(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  //! C_21(p12,p22,s12;m02,m12,m22)
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_22(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_23(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  //! C_23(p12,p22,s12;m02,m12,m22)
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_24(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  if (IsZero(s12) && IsEqual(p12,p22) && IsEqual(m12,m22)) {
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_30(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  if (!IsZero(s12) || !IsEqual(p12,p22) || !IsEqual(m12,m22)) {
...
HELICITIES::DivArrC
HELICITIES::PV_Triangle_38(const double&  p12, const double&  p22, const double&  s12,
                        const Complex& m02, const Complex& m12, const Complex& m22,
                        double mu2=0.) {
  if (mu2 == 0.)   mu2 = GLOBAL_RENORMALISATION_SCALE;
  if (!IsZero(s12) || !IsEqual(p12,p22) || !IsEqual(m12,m22)) {
