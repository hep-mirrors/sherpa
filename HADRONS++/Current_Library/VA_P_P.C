...
void VA_P_P::Calc(const ATOOLS::Vec4D * moms)
{
...
DEFINE_CURRENT_GETTER(VA_P_P,VA_P_P_Getter,"VA_P_P")

void VA_P_P_Getter::PrintInfo(std::ostream &st,const size_t width) const {
