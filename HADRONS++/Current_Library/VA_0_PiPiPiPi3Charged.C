...
DEFINE_CURRENT_GETTER(VA_0_PiPiPiPi3Charged,VA_0_PiPiPiPi3Charged_Getter,"VA_0_PiPiPiPi3Charged")

void VA_0_PiPiPiPi3Charged_Getter::PrintInfo(std::ostream &st,const size_t width) const {
