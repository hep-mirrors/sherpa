...
bool Single_Collision_Handler::FirstMPI(Blob * signal) {
  ///////////////////////////////////////////////////////////////////////////
  // Start the MPI chain by continuing to select a (new) impact parameter of
  // the two colliding hadronic systems until the implicit Sudakov rejection, 
  // which is achieve by a hit-or-miss method, accepts it.  In this process,
  // either a pt^2 smaller than the cut-off is selected or a first MPI blob
