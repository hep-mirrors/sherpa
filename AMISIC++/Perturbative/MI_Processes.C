...
void MI_Processes::CalcPDFs(const double & x1,const double & x2) {
  ...
  ///////////////////////////////////////////////////////////////////////////
  p_pdf[0]->Calculate(x1,Min(Max(m_muF2,p_pdf[0]->Q2Min()),p_pdf[0]->Q2Max()));
  p_pdf[1]->Calculate(x2,Min(Max(m_muF2,p_pdf[1]->Q2Min()),p_pdf[1]->Q2Max()));
}
