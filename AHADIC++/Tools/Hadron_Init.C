...
void Hadron_Init::Init() {
  ...
  if(s_kftable.find(kf_dd_1)==s_kftable.end()) { // if not initialized in Beam
    InitHadron(kf_dd_1,0.77133,0,-2,-3,2,0,0,1,1, "dd_1","dd_1b","dd_1b","dd_1b");
    InitHadron(kf_ud_0,0.57933,0,1,-3,0,0,0,1,1,  "ud_0","ud_0b","ud_0b","ud_0b");
    InitHadron(kf_ud_1,0.77133,0,1,-3,2,0,0,1,1,  "ud_1","ud_1b","ud_1b","ud_1b");
    InitHadron(kf_uu_1,0.77133,0,4,-3,2,0,0,1,1,  "uu_1","uu_1b","uu_1b","uu_1b");
    InitHadron(kf_sd_0,0.80473,0,-2,-3,0,0,0,1,1, "sd_0","sd_0b","sd_0b","sd_0b");
    InitHadron(kf_sd_1,0.92953,0,-2,-3,2,0,0,1,1, "sd_1","sd_1b","sd_1b","sd_1b");
    InitHadron(kf_su_0,0.80473,0,1,-3,0,0,0,1,1,  "su_0","su_0b","su_0b","su_0b");
    InitHadron(kf_su_1,0.92953,0,1,-3,2,0,0,1,1,  "su_1","su_1b","su_1b","su_1b");
    InitHadron(kf_ss_1,1.09361,0,-2,-3,2,0,0,1,1, "ss_1","ss_1b","ss_1b","ss_1b");
    InitHadron(kf_cd_0,1.96908,0,1,-3,0,0,0,1,1,  "cd_0","cd_0b","cd_0b","cd_0b");
    InitHadron(kf_cd_1,2.00808,0,1,-3,2,0,0,1,1,  "cd_1","cd_1b","cd_1b","cd_1b");
    InitHadron(kf_cu_0,1.96908,0,4,-3,0,0,0,1,1,  "cu_0","cu_0b","cu_0b","cu_0b");
    InitHadron(kf_cu_1,2.00808,0,4,-3,2,0,0,1,1,  "cu_1","cu_1b","cu_1b","cu_1b");
    InitHadron(kf_cs_0,2.15432,0,1,-3,0,0,0,1,1,  "cs_0","cs_0b","cs_0b","cs_0b");
    InitHadron(kf_cs_1,2.17967,0,1,-3,2,0,0,1,1,  "cs_1","cs_1b","cs_1b","cs_1b");
    InitHadron(kf_cc_1,3.27531,0,4,-3,2,0,0,1,1,  "cc_1","cc_1b","cc_1b","cc_1b");
    InitHadron(kf_bd_0,5.38897,0,-2,-3,0,0,0,1,1, "bd_0","bd_0b","bd_0b","bd_0b");
    InitHadron(kf_bd_1,5.40145,0,-2,-3,2,0,0,1,1, "bd_1","bd_1b","bd_1b","bd_1b");
    InitHadron(kf_bu_0,5.38897,0,1,-3,0,0,0,1,1,  "bu_0","bu_0b","bu_0b","bu_0b");
    InitHadron(kf_bu_1,5.40145,0,1,-3,2,0,0,1,1,  "bu_1","bu_1b","bu_1b","bu_1b");
    InitHadron(kf_bs_0,5.56725,0,-2,-3,0,0,0,1,1, "bs_0","bs_0b","bs_0b","bs_0b");
    InitHadron(kf_bs_1,5.57536,0,-2,-3,2,0,0,1,1, "bs_1","bs_1b","bs_1b","bs_1b");
    InitHadron(kf_bc_0,6.67143,0,1,-3,0,0,0,1,1,  "bc_0","bc_0b","bc_0b","bc_0b");
    InitHadron(kf_bc_1,6.67397,0,1,-3,2,0,0,1,1,  "bc_1","bc_1b","bc_1b","bc_1b");
    InitHadron(kf_bb_1,10.07354,0,-2,-3,2,0,0,1,1,"bb_1","bb_1b","bb_1b","bb_1b");
  }
  // ##########################################################################
  // ##########################################################################
  ...
  InitHadron(kf_pi_plus,      true, 0.13957,2.5242e-17,3,0,true,1,1,  "pi+","pi^{+}");
  InitHadron(kf_eta,          false,0.5473,1.18e-06,0,0,false,1,0,    "eta","eta");
  InitHadron(kf_K,            false,0.49767,1.e-16,0,0,true,1,0,      "K","K");
  ...
  InitHadron(kf_K_plus,       false,0.493677,5.314e-17,3,0,true,1,1,  "K+","K^{+}");
  InitHadron(kf_eta_prime_958,false,0.95778,0.000203,0,0,false,1,0,   "eta'(958)","eta'(958)");
  InitHadron(kf_D_plus,       false,1.8693,6.23e-13,3,0,true,1,0,     "D+","D^{+}");
  InitHadron(kf_D,            false,1.8646,1.586e-12,0,0,true,1,0,    "D","D");
  InitHadron(kf_D_s_plus,     false,1.9685,1.41e-12,3,0,true,1,0,     "D(s)+","D(s)^{+}");
  InitHadron(kf_eta_c_1S,     false,2.9798,0.0132,0,0,false,1,0,      "eta(c)(1S)","eta_{c}(1S)");
  InitHadron(kf_B,            false,5.2792,4.22e-13,0,0,true,1,0,     "B","B");
  InitHadron(kf_B_plus,       false,5.2789,3.99e-13,3,0,true,1,0,     "B+","B^{+}");
  InitHadron(kf_B_s,          false,5.3693,4.27e-13,0,0,true,1,0,     "B(s)","B_{s}");
  InitHadron(kf_B_c,          false,6.4,1.43e-12,3,0,true,1,0,        "B(c)+","B_{c}^{+}");
  ...
  InitHadron(kf_rho_770_plus,    false,0.77,0.1507,3,2,true,1,0,      "rho(770)+","rho^{+}(770)");
  ...
  InitHadron(kf_B_star,          false,5.3249,0.0001,0,2,true,1,0,    "B*","B*");
  InitHadron(kf_B_star_plus,     false,5.3249,0.0001,3,2,true,1,0,    "B*+","B*^{+}");
  InitHadron(kf_B_s_star,        false,5.41630,0.0001,0,2,true,1,0,   "B(s)*","B_{s}*");
  InitHadron(kf_B_c_star,        false,6.602,0.0001,3,2,true,1,0,     "B(c)*+","B_{c}*^{+}");
  ...
  InitHadron(kf_a_2_1320_plus,     false,1.3181,0.107,3,4,true,1,0,  "a(2)(1320)+","a_{2}^{+}(1320)");
  InitHadron(kf_f_2_1270,          false,1.275,0.1855,0,4,false,1,0, "f(2)(1270)","f_{2}(1270)");
  InitHadron(kf_K_2_star_1430,     false,1.4324,0.109,0,4,true,1,0,  "K(2)*(1430)","K_{2}*(1430)");
  InitHadron(kf_K_2_star_1430_plus,false,1.4256,0.0985,3,4,true,1,0, "K(2)*(1430)+","K_{2}*^{+}(1430)");
  InitHadron(kf_f_2_prime_1525,    false,1.525,0.076,0,4,false,1,0,  "f(2)'(1525)","f_{2}'(1525)");
  InitHadron(kf_D_2_star_2460_plus,false,2.459,0.025,3,4,true,1,0,   "D(2)*(2460)+","D_{2}*^{+}(2460)");
  InitHadron(kf_D_2_star_2460,     false,2.4589,0.023,0,4,true,1,0,  "D(2)*(2460)","D_{2}*(2460)");
  InitHadron(kf_D_s2_star_2573,    false,2.5735,0.015,3,4,true,1,0,  "D(s2)*(2573)+","D_{s2}*^{+}(2573)");
  InitHadron(kf_chi_c2_1P,         false,3.55617,0.002,0,4,false,1,0,"chi(c2)(1P)","chi_{c2}(1P)");
  InitHadron(kf_B_2_star,          false,5.83,0.02,0,4,true,1,0,     "B(2)*","B_{2}*");
  InitHadron(kf_B_2_star_plus,     false,5.83,0.02,3,4,true,1,0,     "B(2)*+","B_{2}*^{+}");
  InitHadron(kf_B_s2_star,         false,5.8397,0.02,0,4,true,1,0,   "B(s2)*","B_{s2}*");
  InitHadron(kf_B_c2_star,         false,7.35,0.02,3,4,true,1,0,     "B(c2)*+","B_{c2}*^{+}");
  ...
  InitHadron(kf_K_0_star_1430,     false,1.429,0.287,0,0,true,1,0,  "K(0)*(1430)","K_{0}*(1430)");
  InitHadron(kf_K_0_star_1430_plus,false,1.429,0.287,3,0,true,1,0,  "K(0)*(1430)+","K_{0}*^{+}(1430)");
  InitHadron(kf_f_0_1710,          false,1.7,0.5,0,0,false,1,0,     "f(0)(1710)","f_{0}(1710)");
  InitHadron(kf_D_0_star_plus,     false,2.351,0.23,3,0,true,1,0,   "D(0)*(2400)+","D_{0}*^{+}(2400)");
  InitHadron(kf_D_0_star,          false,2.318,0.267,0,0,true,1,0,  "D(0)*(2400)","D_{0}*(2400)");
  InitHadron(kf_D_s0_star,         false,2.3177,0.03,3,0,true,1,0,  "D(s0)*(2317)+","D_{s0}*^{+}(2317)");
  InitHadron(kf_chi_c0_1P,         false,3.4173,0.014,0,0,false,1,0,"chi(c0)(1P)","chi_{c0}(1P)");
  InitHadron(kf_B_0_star,          false,5.68,0.05,0,0,true,1,0,    "B(0)*","B_{0}*");
  InitHadron(kf_B_0_star_plus,     false,5.68,0.05,3,0,true,1,0,    "B(0)*+","B_{0}*^{+}");
  InitHadron(kf_B_s0_star,         false,5.92,0.05,0,0,true,1,0,    "B(s0)*","B_{s0}*");
  InitHadron(kf_B_c0_star,         false,7.25,0.05,3,0,true,1,0,    "B(c0)*+","B_{c0}*^{+}");
  ...
  InitHadron(kf_b_1_1235_plus, false,1.2295,0.142,3,2,true,1,0,  "b(1)(1235)+","b_{1}^{+}(1235)");
  InitHadron(kf_h_1_1170,      false,1.17,0.36,0,2,false,1,0,    "h(1)(1170)","h_{1}(1170)");
  InitHadron(kf_K_1_1270,      false,1.272,0.09,0,2,true,1,0,    "K(1)(1270)","K_{1}(1270)");
  InitHadron(kf_K_1_1270_plus, false,1.272,0.09,3,2,true,1,0,    "K(1)(1270)+","K_{1}^{+}(1270)");
  InitHadron(kf_h_1_1380,      false,1.386,0.091,0,2,false,1,0,  "h(1)(1380)","h_{1}(1380)");
  InitHadron(kf_D_1_2420_plus, false,2.4232,0.025,3,2,true,1,0,  "D(1)(2420)+","D_{1}^{+}(2420)");
  InitHadron(kf_D_1_2420,      false,2.4208,0.0317,0,2,true,1,0, "D(1)(2420)","D_{1}(2420)");
  InitHadron(kf_D_s1_2536_plus,false,2.5351,0.00092,3,2,true,1,0,"D(s1)(2536)+","D_{s1}^{+}(2536)");
  InitHadron(kf_h_c1,          false,3.46,0.01,0,2,false,1,0,    "h(c)(1P)","h_{c}(1P)");
  InitHadron(kf_B_1,           false,5.73,0.05,0,2,true,1,0,     "B(1)(L)","B_{1}(L)");
  InitHadron(kf_B_1_plus,      false,5.73,0.05,3,2,true,1,0,     "B(1)(L)+","B_{1}^{+}(L)");
  InitHadron(kf_B_s1,          false,5.97,0.05,0,2,true,1,0,     "B(s1)(L)","B_{s1}(L)");
  InitHadron(kf_B_c1,          false,7.3,0.05,3,2,true,1,0,      "B(c1)(L)+","B_{c1}^{+}(L)");
  ...
  InitHadron(kf_a_1_1260_plus,false,1.23,0.400,3,2,true,1,0,      "a(1)(1260)+","a_{1}^{+}(1260)");
  InitHadron(kf_f_1_1285,     false,1.2819,0.024,0,2,false,1,0,   "f(1)(1285)","f_{1}(1285)");
  InitHadron(kf_K_1_1400,     false,1.402,0.174,0,2,true,1,0,     "K(1)(1400)","K_{1}(1400)");
  InitHadron(kf_K_1_1400_plus,false,1.402,0.174,3,2,true,1,0,     "K(1)(1400)+","K_{1}^{+}(1400)");
  InitHadron(kf_f_1_1420,     false,1.4262,0.055,0,2,false,1,0,   "f(1)(1420)","f_{1}(1420)");
  InitHadron(kf_D_1_H_plus,   false,2.427,0.384,3,2,true,1,0,     "D(1)(H)+","D_{1}^{+}(H)");
  InitHadron(kf_D_1_H,        false,2.427,0.384,0,2,true,1,0,     "D(1)(2430)","D_{1}(2430)");
  InitHadron(kf_D_s1_H,       false,2.4595,0.003,3,2,true,1,0,    "D(s1)(2460)+","D_{s1}^{+}(2460)");
  InitHadron(kf_chi_c1_1P,    false,3.51053,0.00088,0,2,false,1,0,"chi(c1)(1P)","chi_{c1}(1P)");
  InitHadron(kf_B_1_H,        false,5.78,0.05,0,2,true,1,0,       "B(1)(H)","B_{1}(H)");
  InitHadron(kf_B_1_H_plus,   false,5.78,0.05,3,2,true,1,0,       "B(1)(H)+","B_{1}^{+}(H)");
  InitHadron(kf_B_s1_H,       false,6.02,0.05,0,2,true,1,0,       "B(s1)(H)","B_{s1}(H)");
  InitHadron(kf_B_c1_H,       false,7.3,0.05,3,2,true,1,0,        "B(c1)(H)+","B_{c1}^{+}(H)");
  InitHadron(kf_chi_b1_1P,    false,9.8919,0.001,0,2,false,1,0,   "chi(b1)(1P)","chi_{b1}(1P)");
  // ##################################################################################################
  // BARYON MULTIPLETS
  // ##################################################################################################
  // Nucleons (octet) #################################################################################
  InitHadron(kf_n,                     true,0.939566,7.424e-28,0,1,true,1,1,"n","n");
  InitHadron(kf_p_plus,                true,0.938272,0,3,1,true,1,1,        "P+","P^{+}");
  InitHadron(kf_Sigma_minus,           false,1.19745,4.45e-15,-3,1,true,1,0,"Sigma-","\\Sigma^{-}");
  InitHadron(kf_Sigma,                 false,1.19264,8.9e-06,0,1,true,1,0,  "Sigma","\\Sigma");
  InitHadron(kf_Sigma_plus,            false,1.18937,8.24e-15,3,1,true,1,0, "Sigma+","\\Sigma^{+}");
  InitHadron(kf_Lambda,                false,1.11568,2.501e-15,0,1,true,1,0,"Lambda","\\Lambda");
  InitHadron(kf_Xi_minus,              false,1.32132,4.02e-15,-3,1,true,1,0,"Xi-","\\Xi^{-}");
  InitHadron(kf_Xi,                    false,1.3149,2.27e-15,0,1,true,1,0,  "Xi","\\Xi");
  InitHadron(kf_Sigma_c_2455,          false,2.4522,0.0022,0,1,true,1,0,    "Sigma(c)(2455)","\\Sigma_{c}(2455)");
  InitHadron(kf_Sigma_c_2455_plus,     false,2.4536,0.0023,3,1,true,1,0,    "Sigma(c)(2455)+","\\Sigma_{c}^{+}(2455)");
  InitHadron(kf_Sigma_c_2455_plus_plus,false,2.4528,0.0023,6,1,true,1,0,    "Sigma(c)(2455)++","\\Sigma_{c}^{++}(2455)");
  InitHadron(kf_Lambda_c_plus,         false,2.2849,3.19e-12,3,1,true,1,0,  "Lambda(c)+","\\Lambda_{c}^{+}");
  InitHadron(kf_Xi_c_2466,             false,2.4703,5.875e-12,0,1,true,1,0, "Xi(c)","\\Xi_{c}");
  InitHadron(kf_Xi_c_2466_plus,        false,2.4656,1.489e-12,3,1,true,1,0, "Xi(c)+","\\Xi_{c}^{+}");
  InitHadron(kf_Xi_c_2574,             false,2.575,0.001,0,1,true,1,0,      "Xi(c)'","\\Xi'_{c}");
  InitHadron(kf_Xi_c_2574_plus,        false,2.578,0.001,3,1,true,1,0,      "Xi(c)'+","\\Xi'_{c}^{+}");
  InitHadron(kf_Omega_c_0,             false,2.704,1.02e-11,0,1,true,1,0,   "Omega(c)","\\Omega_{c}");
  InitHadron(kf_Sigma_b_5820_minus,    false,5.810,0.001,-3,1,true,1,0,     "Sigma(b)-","\\Sigma_{b}^{-}");
  InitHadron(kf_Sigma_b_5820,          false,5.810,0.001,0,1,true,1,0,      "Sigma(b)","\\Sigma_{b}");
  InitHadron(kf_Sigma_b_5820_plus,     false,5.810,0.001,3,1,true,1,0,      "Sigma(b)+","\\Sigma_{b}^{+}");
  InitHadron(kf_Lambda_b,              false,5.624,5.31e-13,0,1,true,1,0,   "Lambda(b)","\\Lambda_{b}");
  InitHadron(kf_Xi_b_5840,             false,5.790,1.e-13,-3,1,true,1,0,    "Xi(b)-","\\Xi_{b}^{-}");
  InitHadron(kf_Xi_b_5840_minus,       false,5.790,1.e-13,0,1,true,1,0,     "Xi(b)","\\Xi_{b}");
  InitHadron(kf_Xi_b_5960,             false,5.890,1.e-13,-3,1,true,1,0,    "Xi(b)'-_fict","\\Xi'_{b}_fict^{-}");
  InitHadron(kf_Xi_b_5960_minus,       false,5.890,1.e-13,0,1,true,1,0,     "Xi(b)'_fict","\\Xi'_{b}_fict");
  InitHadron(kf_Omega_b_0,             false,6.071,1.e-13,-3,1,true,1,0,    "Omega(b)-","\\Omega_{b}^{-}");
  // Deltas (decuplet) ################################################################################
  InitHadron(kf_Delta_1232_minus,      false,1.232,0.12,-3,3,true,1,0,      "Delta(1232)-","\\Delta-(1232)");
  InitHadron(kf_Delta_1232,            false,1.232,0.12,0,3,true,1,0,       "Delta(1232)","\\Delta(1232)");
  InitHadron(kf_Delta_1232_plus,       false,1.232,0.12,3,3,true,1,0,       "Delta(1232)+","\\Delta^{+}(1232)");
  InitHadron(kf_Delta_1232_plus_plus,  false,1.232,0.12,6,3,true,1,0,       "Delta(1232)++","\\Delta^{++}(1232)");
  InitHadron(kf_Sigma_1385_minus,      false,1.3872,0.0394,-3,3,true,1,0,   "Sigma(1385)-","\\Sigma-(1385)");
  InitHadron(kf_Sigma_1385,            false,1.3837,0.036,0,3,true,1,0,     "Sigma(1385)","\\Sigma(1385)");
  InitHadron(kf_Sigma_1385_plus,       false,1.3828,0.0358,3,3,true,1,0,    "Sigma(1385)+","\\Sigma^{+}(1385)");
  InitHadron(kf_Xi_1530_minus,         false,1.535,0.0099,-3,3,true,1,0,    "Xi(1530)-","\\Xi-(1530)");
  InitHadron(kf_Xi_1530,               false,1.5318,0.0091,0,3,true,1,0,    "Xi(1530)","\\Xi(1530)");
  InitHadron(kf_Omega_minus,           false,1.67245,8.01e-15,-3,3,true,1,0,"Omega-","\\Omega^{-}");
  InitHadron(kf_Sigma_c_2520,          false,2.5175,0.0150,0,3,true,1,0,    "Sigma(c)(2520)","\\Sigma_{c}(2520)");
  InitHadron(kf_Sigma_c_2520_plus,     false,2.5159,0.0150,3,3,true,1,0,    "Sigma(c)(2520)+","\\Sigma_{c}^{+}(2520)");
  InitHadron(kf_Sigma_c_2520_plus_plus,false,2.5194,0.0150,6,3,true,1,0,    "Sigma(c)(2520)++","\\Sigma_{c}^{++}(2520)");
  InitHadron(kf_Xi_c_2645,             false,2.645,0.003,0,3,true,1,0,      "Xi(c)*","\\Xi*_{c}");
  InitHadron(kf_Xi_c_2645_plus,        false,2.645,0.003,3,3,true,1,0,      "Xi(c)*+","\\Xi*_{c}^{+}");
  InitHadron(kf_Omega_c_star,          false,2.8,0.001,0,3,true,1,0,        "Omega(c)*","\\Omega*_{c}");
  InitHadron(kf_Sigma_b_5840_minus,    false,5.829,0.01,-3,3,true,1,0,      "Sigma(b)*-","\\Sigma*_{b}^{-}");
  InitHadron(kf_Sigma_b_5840,          false,5.829,0.01,0,3,true,1,0,       "Sigma(b)*","\\Sigma*_{b}");
  InitHadron(kf_Sigma_b_5840_plus,     false,5.829,0.01,3,3,true,1,0,       "Sigma(b)*+","\\Sigma*_{b}^{+}");
  InitHadron(kf_Xi_b_5940,             false,5.930,0.001,-3,3,true,1,0,     "Xi(b)*-_fict","\\Xi*_{b}_fict^{-}");
  InitHadron(kf_Xi_b_5940_minus,       false,5.930,0.001,0,3,true,1,0,      "Xi(b)*_fict","\\Xi*_{b}_fict");
  InitHadron(kf_Omega_b_star,          false,6.090,0.0003,-3,3,true,1,0,    "Omega(b)*-_fict","\\Omega*_{b}_fict^{-}");
  // Nucleons (octet) - L_N = 1 ##############################################
  // careful - we will have to add some heavy states here!
  InitHadron(kf_N_1535,          false,1.535,0.15,0,1,true,1,0,   "N(1535)","N(1535)");
  InitHadron(kf_N_1535_plus,     false,1.535,0.15,3,1,true,1,0,   "N(1535)+","N^{+}(1535)");
  InitHadron(kf_Sigma_1620_minus,false,1.62,0.09,-3,1,true,1,0,   "Sigma(1620)-","\\Sigma-(1620)");
  ...
  // careful - we will have to add some heavy states here!
  InitHadron(kf_N_1440,          true,1.44,0.35,0,1,true,1,0,    "N(1440)","N(1440)");
  InitHadron(kf_N_1440_plus,     true,1.44,0.35,3,1,true,1,0,    "N(1440)+","N^{+}(1440)");
  InitHadron(kf_Sigma_1660_minus,false,1.66,0.1,-3,1,true,1,0,   "Sigma(1660)-","\\Sigma-(1660)");
  InitHadron(kf_Sigma_1660,      false,1.66,0.1,0,1,true,1,0,    "Sigma(1660)","\\Sigma(1660)");
  InitHadron(kf_Sigma_1660_plus, false,1.66,0.1,3,1,true,1,0,    "Sigma(1660)+","\\Sigma^{+}(1660)");
  InitHadron(kf_Lambda_1600,     false,1.6,0.15,0,1,true,1,0,    "Lambda(1600)","\\Lambda(1600)");
  InitHadron(kf_Xi_1690_minus,   false,1.696,0.010,-3,1,true,1,0,"Xi(1690)-","\\Xi-(1690)");
  InitHadron(kf_Xi_1690,         false,1.696,0.010,0,1,true,1,0, "Xi(1690)","\\Xi(1690)");
  // Nucleons (octet) - L_N = 1_1 -- plus "singlet heavies" ###########################################
  InitHadron(kf_N_1520,          false,1.52,0.12,0,3,true,1,0,    "N(1520)","N(1520)");
  InitHadron(kf_N_1520_plus,     false,1.52,0.12,3,3,true,1,0,    "N(1520)+","N^{+}(1520)");
  InitHadron(kf_Sigma_1670_minus,false,1.67,0.06,-3,3,true,1,0,   "Sigma(1670)-","\\Sigma-(1670)");
  InitHadron(kf_Sigma_1670,      false,1.67,0.06,0,3,true,1,0,    "Sigma(1670)","\\Sigma(1670)");
  InitHadron(kf_Sigma_1670_plus, false,1.67,0.06,3,3,true,1,0,    "Sigma(1670)+","\\Sigma^{+}(1670)");
  InitHadron(kf_Lambda_1690,     false,1.69,0.06,0,3,true,1,0,    "Lambda(1690)","\\Lambda(1690)");
