...
void Hadronisation_Parameters::Init(string dir,string file)
{
  ...
  for (StringDoubleMap::iterator it=m_parametermap.begin();
       it!=m_parametermap.end(); it++) {
