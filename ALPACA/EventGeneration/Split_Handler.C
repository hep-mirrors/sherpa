...
pair<double, partpair> Split_Handler::DoSplittingKinematics(double tausplit, splitpair split_pair){
    ...
    */
    ...
    //msg_Out() << "Post split: [" << part_in->GetFlow(1) << ", " << part_in->GetFlow(2) << "] -> [" << part_out_1_ptr->GetFlow(1) << ", " << part_out_1_ptr->GetFlow(2) << "] [" << part_out_2_ptr->GetFlow(1) << ", " << part_out_2_ptr->GetFlow(2) << "]" << endl;
