...
namespace Rivet {
  ...
  public:
    ...
    void inithistos() {
      ...
      //
      _h_jetb_1_jetb_2_dR    = bookHistogram1D("jetb_1_jetb_2_dR", 
					       28, 0.0, 7.0);
      _h_jetb_1_jetb_2_deta  = bookHistogram1D("jetb_1_jetb_2_deta", 
					       28, 0.0, 7.0);
      _h_jetb_1_jetb_2_dphi = bookHistogram1D("jetb_1_jetb_2_dphi", 
					      32, 0.0, 6.2);
      _h_jetl_1_jetl_2_dR = bookHistogram1D("jetl_1_jetl_2_dR", 
					    28, 0.0, 7.0);
      _h_jetl_1_jetl_2_deta  = bookHistogram1D("jetl_1_jetl_2_deta", 
					       28, 0.0, 7.0);
      _h_jetl_1_jetl_2_dphi = bookHistogram1D("jetl_1_jetl_2_dphi", 
					      32, 0.0, M_PI);
    }
	...
	_h_ljet_2_pT->fill(ljets[1].momentum().pT(), weight);
      ...
      if (nbjets==2) {
	_h_jetb_1_jetb_2_dR->fill(deltaR(bjets[0].momentum(), 
					 bjets[1].momentum()),weight);
        _h_jetb_1_jetb_2_deta->fill(fabs(bjets[0].momentum().eta()-
					 bjets[1].momentum().eta()),weight);
        _h_jetb_1_jetb_2_dphi->fill(deltaPhi(bjets[0].momentum(),
					     bjets[1].momentum()),weight);
      }
