...
G = Parameter(name = 'G',
              nature = 'internal',
              type = 'real',
              value = '2*cmath.sqrt(0.1172)*cmath.sqrt(cmath.pi)',
              texname = 'G')

c12 = Parameter(name = 'c12',
                nature = 'internal',
                type = 'real',
                value = 'cmath.sqrt(1.0 - 0.221**2)',
                texname = '\\text{c12}')

c23 = Parameter(name = 'c23',
                nature = 'internal',
                type = 'real',
                # value = 'cmath.sqrt(1.0 - s23**2)',
                value = 1,
                texname = '\\text{c23}')
...
#                   nature = 'internal',
#                   type = 'real',
#                   value = '2.0*cmath.sqrt(amass)*cmath.sqrt(cmath.pi)',
#                   texname = '\\text{gmass}')
...
#                value = 'cmath.log(LR**2)/(16.*cmath.pi**2*1.)',
#                texname = '\\text{mn}')
...
ee = Parameter(name = 'ee',
               nature = 'internal',
               type = 'real',
               value = '2.0*cmath.sqrt(1/137.036)*cmath.sqrt(cmath.pi)',
            #    value = 'cmath.sqrt(1/137)*cmath.sqrt(cmath.pi)',
               texname = 'e')
...
g1 = Parameter(name = 'g1',
               nature = 'internal',
               type = 'real',
               value = '2.0*cmath.sqrt(1/137)*cmath.sqrt(cmath.pi)/cmath.sqrt(1 - 0.48076**2)',
               texname = 'g_1')
...
#                 nature = 'internal',
#                 type = 'real',
#                 value = '((9.0*g1**2)/16. + (27.0*gw**2)/16.)*mn',
#                 texname = '\\text{mL2}')

# mQ2 = Parameter(name = 'mQ2',
#                 nature = 'internal',
#                 type = 'real',
#                 value = '(g1**2/16. + 3.0*gmass**2 + (27.0*gw**2)/16.)*mn',
#                 texname = '\\text{mQ2}')
...
#                 nature = 'internal',
#                 type = 'real',
#                 value = '(mn*((3.0*g1**2)/4. + (3.0*gw**2)/2. - MH**2/v**2))/R',
#                 texname = '\\text{cH2}')
...
#                 nature = 'internal',
#                 type = 'real',
#                 value = '(-3.0*mn*ymt**2)/(2.*v**2)',
#                 texname = '\\text{mQt}')

# mt0 = Parameter(name = 'mt0',
#                 nature = 'internal',
#                 type = 'real',
#                 value = '(-3.0*mn*ymt**2)/v**2',
#                 texname = '\\text{mt0}')
...
#                nature = 'internal',
#                type = 'real',
#                value = '(ymc*cmath.sqrt(2.0))/v',
#                texname = '\\text{yc}')

# yt = Parameter(name = 'yt',
#                nature = 'internal',
#                type = 'real',
#                value = '(ymt*cmath.sqrt(2.0))/v',
#                texname = '\\text{yt}')

# ytau = Parameter(name = 'ytau',
#                  nature = 'internal',
#                  type = 'real',
#                  value = '(ymtau*cmath.sqrt(2.0))/v',
#                  texname = '\\text{ytau}')

# Delta = Parameter(name = 'Delta',
#                   nature = 'internal',
#                   type = 'real',
#                   value = 'cmath.sqrt(4.0*MM12**2 + (MM11 - MM22)**2)',
#                   texname = '\\text{Delta}')

# DMb = Parameter(name = 'DMb',
#                 nature = 'internal',
#                 type = 'real',
#                 value = '(-md2 + mQ2 + mQt + cmath.sqrt((md2 + mQ2 + mQt + 2.0/R)**2 + 4.0*ymb**2))/2.',
#                 texname = '\\text{DMb}')

# DMtop = Parameter(name = 'DMtop',
#                   nature = 'internal',
#                   type = 'real',
#                   value = '(-mQ2 - mQt + mt0 + mu2 + cmath.sqrt((mQ2 + mQt + mt0 + mu2 + 2.0/R)**2 + 4.0*ymt**2))/2.',
#                   texname = '\\text{DMtop}')
...
#                 nature = 'internal',
#                 type = 'real',
#                 value = 'cmath.sqrt(-Delta + MM11 + MM22)/cmath.sqrt(2.0)',
#                 texname = '\\text{MB1}')
...
WPion = Parameter(name = 'WPion',
               nature = 'internal',
               type = 'real',
               value = 0,
               texname = '\\text{W\\pi}')

# PionFF = Parameter(name = 'PionFormFactor',
#                nature = 'internal',
#                type = 'string',
#                value = 'pion_ff_gounaris_sakurai',
#                texname = 'Pion FormFactor')
