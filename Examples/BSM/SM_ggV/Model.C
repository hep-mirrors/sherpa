...
void SM_GGV::ParticleInit()
{
  ...
  AddParticle(kf_t,173.21,0,2.0,2,3,1,0,1,0,1,"t","tb", "t", "\\bar{t}");
  ...
  AddParticle(kf_Wplus,80.385,0,2.085,3,0,2,0,1,0,1,"W+","W-","W^{+}","W^{-}");
  AddParticle(kf_h0,125.,0,0.00407,0,0,0,-1,1,0,1,"h0","h0","h_{0}","h_{0}");
