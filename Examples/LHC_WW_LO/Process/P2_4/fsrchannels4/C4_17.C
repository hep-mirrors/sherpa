...
namespace PHASIC {
  class C4_17 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_3_4,m_kI_5_34,m_kTC_0__1__345_2,m_kZS_180;
    Vegas* p_vegas;
  public:
    C4_17(int,int,Flavour*,Integration_Info * const);
    ~C4_17();
...
extern "C" Single_Channel * Getter_C4_17(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_17(nin,nout,fl,info);
}

void C4_17::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
...
void C4_17::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
...
C4_17::C4_17(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_17");
  rannum = 8;
...
void C4_17::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 180.94275;
  width = 0.;
...
void C4_17::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_17::ChID()
{
  return std::string("CG2$I_3_4$I_5_34$MP24_34$MTH_345$TC_0__1__345_2$ZS_180$");
}
