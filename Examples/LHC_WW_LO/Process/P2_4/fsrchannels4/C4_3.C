...
namespace PHASIC {
  class C4_3 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_3_4,m_kTC_0_2_1__5_34,m_kTC_0__1__2_345,m_kZS_180;
    Vegas* p_vegas;
  public:
    C4_3(int,int,Flavour*,Integration_Info * const);
    ~C4_3();
...
extern "C" Single_Channel * Getter_C4_3(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_3(nin,nout,fl,info);
}

void C4_3::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  CE.TChannelMomenta(p[0],p[1],p[2],p345,s2,s345,0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,ran[2],ran[3]);
  Vec4D  p0_2 = p[0]-p[2];
  CE.TChannelMomenta(p0_2,p[1],p[5],p34,s5,s34,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
  CE.Isotropic2Momenta(p34,s3,s4,p[3],p[4],ran[6],ran[7]);
}

void C4_3::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
  ...
  m_ctmax = cuts->cosmax[0][2];
  m_ctmin = cuts->cosmin[0][2];
  if (m_kTC_0__1__2_345.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1__2_345<<CE.TChannelWeight(p[0],p[1],p[2],p345,0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,m_kTC_0__1__2_345[0],m_kTC_0__1__2_345[1]);
  wt *= m_kTC_0__1__2_345.Weight();

  rans[2]= m_kTC_0__1__2_345[0];
  rans[3]= m_kTC_0__1__2_345[1];
  Vec4D  p0_2 = p[0]-p[2];
  if (m_kTC_0_2_1__5_34.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_2_1__5_34<<CE.TChannelWeight(p0_2,p[1],p[5],p34,0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0_2_1__5_34[0],m_kTC_0_2_1__5_34[1]);
  wt *= m_kTC_0_2_1__5_34.Weight();

  rans[4]= m_kTC_0_2_1__5_34[0];
  rans[5]= m_kTC_0_2_1__5_34[1];
...
C4_3::C4_3(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_3");
  rannum = 8;
  ...
  m_kTC_0_2_1__5_34.Assign(std::string("TC_0_2_1__5_34"),2,0,info);
  m_kTC_0__1__2_345.Assign(std::string("TC_0__1__2_345"),2,0,info);
...
void C4_3::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 180.94275;
  width = 0.;
...
void C4_3::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_3::ChID()
{
  return std::string("CG2$I_3_4$MP24_34$MTH_345$TC_0_2_1__5_34$TC_0__1__2_345$ZS_180$");
}
