...
namespace PHASIC {
  class C4_0 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_3_4,m_kTC_0__1_5_2_34,m_kTC_0__1__234_5,m_kZS_180;
    Vegas* p_vegas;
  public:
    C4_0(int,int,Flavour*,Integration_Info * const);
    ~C4_0();
...
extern "C" Single_Channel * Getter_C4_0(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_0(nin,nout,fl,info);
}

void C4_0::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p1_5 = p[1]-p[5];
  CE.TChannelMomenta(p[0],p1_5,p[2],p34,s2,s34,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
  CE.Isotropic2Momenta(p34,s3,s4,p[3],p[4],ran[6],ran[7]);
}

void C4_0::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
  ...
  Vec4D  p1_5 = p[1]-p[5];
  if (m_kTC_0__1_5_2_34.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_5_2_34<<CE.TChannelWeight(p[0],p1_5,p[2],p34,0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_5_2_34[0],m_kTC_0__1_5_2_34[1]);
  wt *= m_kTC_0__1_5_2_34.Weight();

  rans[4]= m_kTC_0__1_5_2_34[0];
  rans[5]= m_kTC_0__1_5_2_34[1];
...
C4_0::C4_0(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_0");
  rannum = 8;
  ...
  m_kTC_0__1_5_2_34.Assign(std::string("TC_0__1_5_2_34"),2,0,info);
...
void C4_0::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 180.94275;
  width = 0.;
...
void C4_0::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_0::ChID()
{
  return std::string("CG2$I_3_4$MP24_34$MTH_234$TC_0__1_5_2_34$TC_0__1__234_5$ZS_180$");
}
