...
namespace PHASIC {
  class C4_6 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_3_4,m_kTC_0__1_2_34_5,m_kTC_0__1__345_2,m_kZS_180;
    Vegas* p_vegas;
  public:
    C4_6(int,int,Flavour*,Integration_Info * const);
    ~C4_6();
...
extern "C" Single_Channel * Getter_C4_6(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_6(nin,nout,fl,info);
}

void C4_6::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  s345_min = Max(s345_min,sqr(sqrt(s34)+sqrt(s5)));
  Vec4D  p345;
  ...
  CE.TChannelMomenta(p[0],p[1],p345,p[2],s345,s2,0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,ran[2],ran[3]);
  Vec4D  p1_2 = p[1]-p[2];
  CE.TChannelMomenta(p[0],p1_2,p34,p[5],s34,s5,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
  CE.Isotropic2Momenta(p34,s3,s4,p[3],p[4],ran[6],ran[7]);
}

void C4_6::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
  ...
  m_ctmax = cuts->cosmax[1][2];
  m_ctmin = cuts->cosmin[1][2];
  if (m_kTC_0__1__345_2.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1__345_2<<CE.TChannelWeight(p[0],p[1],p345,p[2],0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,m_kTC_0__1__345_2[0],m_kTC_0__1__345_2[1]);
  wt *= m_kTC_0__1__345_2.Weight();

  rans[2]= m_kTC_0__1__345_2[0];
  rans[3]= m_kTC_0__1__345_2[1];
  Vec4D  p1_2 = p[1]-p[2];
  if (m_kTC_0__1_2_34_5.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_2_34_5<<CE.TChannelWeight(p[0],p1_2,p34,p[5],0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_2_34_5[0],m_kTC_0__1_2_34_5[1]);
  wt *= m_kTC_0__1_2_34_5.Weight();

  rans[4]= m_kTC_0__1_2_34_5[0];
  rans[5]= m_kTC_0__1_2_34_5[1];
...
C4_6::C4_6(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_6");
  rannum = 8;
  ...
  m_kTC_0__1_2_34_5.Assign(std::string("TC_0__1_2_34_5"),2,0,info);
  m_kTC_0__1__345_2.Assign(std::string("TC_0__1__345_2"),2,0,info);
...
void C4_6::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 180.94275;
  width = 0.;
...
void C4_6::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_6::ChID()
{
  return std::string("CG2$I_3_4$MP24_34$MTH_345$TC_0__1_2_34_5$TC_0__1__345_2$ZS_180$");
}
