...
namespace PHASIC {
  class C3_1 : public Single_Channel {
    Info_Key m_kI_2_34,m_kI_3_4,m_kZR24_120;
    Vegas* p_vegas;
  public:
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_kZR24_120.Assign(std::string("ZR24_120"),2,0,info);
...
{
  type  = 1;
  mass  = Flavour((kf_code)(24)).Mass();
  width = Flavour((kf_code)(24)).Width();
}
...
{
  return std::string("CG2$I_2_34$I_3_4$MP24_34$ZR24_120$");
}
