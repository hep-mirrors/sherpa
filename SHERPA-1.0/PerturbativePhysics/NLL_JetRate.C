...
//     std::cout<<" "<<gq<<" "<<gg<<" "<<dq<<" "<<dg<<std::endl;
//     std::cout<<" "<<gqm<<" "<<gg<<" "<<dqm<<" "<<dgm<<std::endl;
  }
  ...
  /*
  std::cout<<" intgqdg = "<<intgqdg<<std::endl;
  std::cout<<" intgqDG = "<<intgqDG<<std::endl;

  std::cout<<" deltag  = "<<(*p_deltag)(q,m_qmin);
  std::cout<<" deltagm = "<<(*p_deltagm)(q,m_qmin);
  */
