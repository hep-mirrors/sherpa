...
sphinx-multiversion doc/ $OUTDIR/_multi -- -c $MV_CONFDIR -A mode=html -A pdf=sherpamanual.pdf \
                    & sphinx-multiversion doc/ $OUTDIR/_single -- -c $MV_CONFDIR -b singlehtml -A mode=singlehtml -A pdf=sherpamanual.pdf \
                    & sphinx-multiversion doc/ $OUTDIR/_pdf -- -c $MV_CONFDIR -b latex
