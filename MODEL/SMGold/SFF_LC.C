...
namespace METOOLS {
  ...
  };// end of class FFG_Worker

  template class FFG_Worker<double>;

  template <typename SType>
  class FFG_Calculator: public Lorentz_Calculator, 
			public FFG_Worker<SType> {
  public:
    
    typedef CSpinor<SType> CSpinorType;
    typedef CScalar<SType> CScalarType;

    FFG_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FFG"; }
  ...
  };// end of class FFG_Calculator

  template class FFG_Calculator<double>;

  template <typename SType>
  class FFGL_Calculator: public Lorentz_Calculator, 
			 public FFG_Worker<SType> {
  public:
    ...
    FFGL_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FFGL"; }
  ...
  };// end of class FFGL_Calculator

  template class FFGL_Calculator<double>;

  template <typename SType>
  class FFGR_Calculator: public Lorentz_Calculator, 
			 public FFG_Worker<SType> {
  public:
    ...
    FFGR_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FFGR"; }
  ...
  };// end of class FFGR_Calculator

  template class FFGR_Calculator<double>;

}// end of namespace METOOLS

using namespace METOOLS;

DECLARE_GETTER(FFG_Calculator<double>,"DFFG",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FFG_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FFG_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FFG_Calculator<double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"FFG vertex"; }

DECLARE_GETTER(FFGL_Calculator<double>,"DFFGL",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FFGL_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FFGL_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FFGL_Calculator<double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"FFGL vertex"; }

DECLARE_GETTER(FFGR_Calculator<double>,"DFFGR",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FFGR_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FFGR_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FFGR_Calculator<double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"FFGR vertex"; }
