...
namespace METOOLS {
  ...
  template <typename SType>
  class FFS2_Calculator: public Lorentz_Calculator {
  public:
    ...
    FFS2_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FFS2"; }
  ...
  };// end of class FFS2_Calculator

  template class FFS2_Calculator<double>;
...
DECLARE_GETTER(FFS2_Calculator<double>,"DFFS2",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FFS2_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FFS2_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FFS2_Calculator<double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"FFS2 vertex"; }
