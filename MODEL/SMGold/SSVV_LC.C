...
namespace METOOLS {
  ...
  class VVGG_Calculator: public Lorentz_Calculator {
  public:
    
    typedef CVec4<SType> CVec4Type;
    typedef CScalar<SType> CScalarType;

    VVGG_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "VVGG"; }
  ...
  };// end of class VVGG_Calculator

  template class VVGG_Calculator<double>;

}// end of namespace METOOLS

using namespace METOOLS;

DECLARE_GETTER(VVGG_Calculator<double>,"DVVGG",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVGG_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new VVGG_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVGG_Calculator<double> >::
