...
namespace METOOLS {
  ...
  class VVSS1_Calculator: public Lorentz_Calculator {
  public:
    ...
    VVSS1_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "VVSS1"; }
	...
	CVec4<SType>* j0 = NULL;
	j0 = CVec4<SType>::New();
	(*j0)[0] = 1.0*j10*j20*j30;
	(*j0)[ATOOLS::Spinor<SType>::R1()] = 1.0*j11*j20*j30;
	(*j0)[ATOOLS::Spinor<SType>::R2()] = 1.0*j12*j20*j30;
	(*j0)[ATOOLS::Spinor<SType>::R3()] = 1.0*j13*j20*j30;
	...
	CVec4<SType>* j1 = NULL;
	j1 = CVec4<SType>::New();
	(*j1)[0] = 1.0*j00*j20*j30;
	(*j1)[ATOOLS::Spinor<SType>::R1()] = 1.0*j01*j20*j30;
	(*j1)[ATOOLS::Spinor<SType>::R2()] = 1.0*j02*j20*j30;
	(*j1)[ATOOLS::Spinor<SType>::R3()] = 1.0*j03*j20*j30;
	...
	j2 = CScalar<SType>::New(1.0*j00*j10*j30 - 1.0*j01*j11*j30 - 1.0*j02*j12*j30 - 1.0*j03*j13*j30);
	...
	j3 = CScalar<SType>::New(1.0*j00*j10*j20 - 1.0*j01*j11*j20 - 1.0*j02*j12*j20 - 1.0*j03*j13*j20);
  ...
  };// end of class VVSS1_Calculator

  template class VVSS1_Calculator<double>;
...
DECLARE_GETTER(VVSS1_Calculator<double>,"DVVSS1",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVSS1_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new VVSS1_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVSS1_Calculator<double> >::
