...
namespace MODEL{
  ...
  protected:
    ...
    void vertices_5 () {
      ...
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_38",m_local_complex_constants["GC_38"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_38",m_local_complex_constants["GC_38"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_37",m_local_complex_constants["GC_37"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_37",m_local_complex_constants["GC_37"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_38",m_local_complex_constants["GC_38"]) );
    ...
    void vertices_8 () {
      ...
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_11",m_local_complex_constants["GC_11"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_11",m_local_complex_constants["GC_11"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_13",m_local_complex_constants["GC_13"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_13",m_local_complex_constants["GC_13"]) );
      m_v.back().cpl.push_back( ATOOLS::Kabbala("GC_11",m_local_complex_constants["GC_11"]) );
