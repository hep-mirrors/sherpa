#include "MODEL/ScalarQED/Model.H"
...
DECLARE_GETTER(MODEL::ScalarQED_Model,"ScalarQED",MODEL::Model_Base,MODEL::Model_Arguments);

Model_Base *ATOOLS::Getter<MODEL::Model_Base,MODEL::Model_Arguments,MODEL::ScalarQED_Model>::
operator()(const Model_Arguments &args) const
{
  return new ScalarQED_Model();
}
...
ScalarQED_Model::ScalarQED_Model() :
  Model_Base(true)
{
  m_name="ScalarQED";
  ParticleInit();
...
void ScalarQED_Model::ParticleInit()
{
...
bool ScalarQED_Model::ModelInit()
{
  FixEWParameters();
  FixCKM();
...
void ScalarQED_Model::FixEWParameters()
{
  Settings& s = Settings::GetMainSettings();
...
void ScalarQED_Model::InitVertices()
{
  InitQEDVertices();
  InitQCDVertices();
  InitEWVertices();
...
void ScalarQED_Model::InitQCDVertices()
{
  Settings& s = Settings::GetMainSettings();
...
void ScalarQED_Model::InitEWVertices()
{
