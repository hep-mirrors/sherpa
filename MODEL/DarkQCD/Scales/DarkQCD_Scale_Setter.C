...
namespace PHASIC {
  ...
  class DarkQCD_Scale_Setter: public Scale_Setter_Base {
  private:
  ...
  public:
    ...
    DarkQCD_Scale_Setter(const Scale_Setter_Arguments &args,
		      const int mode=1);

    ~DarkQCD_Scale_Setter();
  ...
  };// end of class DarkQCD_Scale_Setter
...
DECLARE_GETTER(DarkQCD_Scale_Setter,"DarkQCD",
	       Scale_Setter_Base,Scale_Setter_Arguments);

Scale_Setter_Base *ATOOLS::Getter
<Scale_Setter_Base,Scale_Setter_Arguments,DarkQCD_Scale_Setter>::
operator()(const Scale_Setter_Arguments &args) const
{
  return new DarkQCD_Scale_Setter(args,1);
}
...
{ 
  str<<"meps scale scheme for DarkQCD";
}

int DarkQCD_Scale_Setter::s_nfgsplit(-1);
int DarkQCD_Scale_Setter::s_nlocpl(-1);

DarkQCD_Scale_Setter::DarkQCD_Scale_Setter
  ...
  Scale_Setter_Base(args), m_tagset(this)
{
  ...
  if (p_proc->Shower()==NULL){
    ...
    THROW(missing_input,"No shower generator found. Unable to use the DarkQCD scale scheme.");
  }
...
bool DarkQCD_Scale_Setter::Initialize()
{
  int sout(0);
...
int DarkQCD_Scale_Setter::Select
...
bool DarkQCD_Scale_Setter::CheckOrdering
...
bool DarkQCD_Scale_Setter::CheckSplitting
...
bool DarkQCD_Scale_Setter::CheckSubEvents(const Cluster_Config &cc) const
{
...
void DarkQCD_Scale_Setter::Combine
...
double DarkQCD_Scale_Setter::Calculate
...
bool DarkQCD_Scale_Setter::CoreCandidate(Cluster_Amplitude *const ampl) const
{
...
void DarkQCD_Scale_Setter::Cluster
...
bool DarkQCD_Scale_Setter::ClusterStep
...
double DarkQCD_Scale_Setter::Differential
...
void DarkQCD_Scale_Setter::SetCoreScale(Cluster_Amplitude *const ampl)
{
...
double DarkQCD_Scale_Setter::SetScales(Cluster_Amplitude *ampl)
{
...
void DarkQCD_Scale_Setter::SetScale
