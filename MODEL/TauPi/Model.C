...
Standard_Model_TauPi::Standard_Model_TauPi() :
  Model_Base(1)
{
  m_name="TauPi";
  ParticleInit();
...
bool Standard_Model_TauPi::ModelInit(PDF::PDF_Base* pdf)
{
  FixEWParameters();  
  FixCKM();
...
void Standard_Model_TauPi::InitQCDVertices()
{
  ...
  m_dec_g4 = Settings::GetMainSettings()["DECOMPOSE_4G_VERTEX"].Get<int>();
