...
{ 
  if (m_a==m_p) {
    ...
    */
    m_colours[0][m_a] = m_colours[3-m_r][m_a] = Flow::Counter();
    m_colours[1][m_a] = m_colours[2+m_r][m_a] = Flow::Counter();
  ...
  ME2_Base(args)
{
  ...
  m_oew=0; m_oqcd=2;
  m_cfls[PropID(0,1)] = Flavour_Vector{};
  m_cfls[PropID(2,3)] = Flavour_Vector{};
