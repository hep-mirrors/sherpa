...
VirtualVirtual::VirtualVirtual(const PHASIC::Process_Info& pi)
  {
...
double VirtualVirtual::Calc(const ATOOLS::Vec4D_Vector momenta, double born){
...
double VirtualVirtual::Calc_V(const ATOOLS::Vec4D_Vector& p,
           const double B,
           const double mur)
  {
