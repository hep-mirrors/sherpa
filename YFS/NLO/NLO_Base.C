...
double NLO_Base::CalculateRealReal(Vec4D k1, Vec4D k2, int fsr1, int fsr2) {
  ...
  double sub1 = (fsr1 != 1 ? p_dipoles->CalculateRealSubEEX(k1)
                           : p_dipoles->CalculateRealSubEEX(k1));
  double sub2 = (fsr2 != 1 ? p_dipoles->CalculateRealSubEEX(k2)
                           : p_dipoles->CalculateRealSubEEX(k2));
  double fullsub =
