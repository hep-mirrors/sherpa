...
DECLARE_GETTER(VVSS_Calculator<long double>,"QVVSS",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVSS_Calculator<long double> >::
operator()(const Vertex_Key &key) const
{ return new VVSS_Calculator<long double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVSS_Calculator<long double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVSS vertex"; }
// ---- QPREC_END ----
// ---- XPREC_BEGIN: double-double instantiation ----
DECLARE_GETTER(VVSS_Calculator<ATOOLS::DDouble>,"XVVSS",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVSS_Calculator<ATOOLS::DDouble> >::
operator()(const Vertex_Key &key) const
{ return new VVSS_Calculator<ATOOLS::DDouble>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVSS_Calculator<ATOOLS::DDouble> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVSS vertex"; }
// ---- XPREC_END ----
