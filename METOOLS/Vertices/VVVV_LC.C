...
DECLARE_GETTER(VVVVA_Calculator<long double>,"QVVVVA",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVVA_Calculator<long double> >::
operator()(const Vertex_Key &key) const
{ return new VVVVA_Calculator<long double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVVA_Calculator<long double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVVA vertex"; }

DECLARE_GETTER(VVVVB_Calculator<long double>,"QVVVVB",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVVB_Calculator<long double> >::
operator()(const Vertex_Key &key) const
{ return new VVVVB_Calculator<long double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVVB_Calculator<long double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVVB vertex"; }

DECLARE_GETTER(VVVVC_Calculator<long double>,"QVVVVC",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVVC_Calculator<long double> >::
operator()(const Vertex_Key &key) const
{ return new VVVVC_Calculator<long double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVVC_Calculator<long double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVVC vertex"; }

DECLARE_GETTER(VVVV_Calculator<long double>,"QVVVV",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVV_Calculator<long double> >::
operator()(const Vertex_Key &key) const
{ return new VVVV_Calculator<long double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVV_Calculator<long double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVV vertex"; }
// ---- QPREC_END ----
// ---- XPREC_BEGIN: double-double instantiation ----
DECLARE_GETTER(VVVVA_Calculator<ATOOLS::DDouble>,"XVVVVA",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVVA_Calculator<ATOOLS::DDouble> >::
operator()(const Vertex_Key &key) const
{ return new VVVVA_Calculator<ATOOLS::DDouble>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVVA_Calculator<ATOOLS::DDouble> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVVA vertex"; }

DECLARE_GETTER(VVVVB_Calculator<ATOOLS::DDouble>,"XVVVVB",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVVB_Calculator<ATOOLS::DDouble> >::
operator()(const Vertex_Key &key) const
{ return new VVVVB_Calculator<ATOOLS::DDouble>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVVB_Calculator<ATOOLS::DDouble> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVVB vertex"; }

DECLARE_GETTER(VVVVC_Calculator<ATOOLS::DDouble>,"XVVVVC",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVVC_Calculator<ATOOLS::DDouble> >::
operator()(const Vertex_Key &key) const
{ return new VVVVC_Calculator<ATOOLS::DDouble>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVVC_Calculator<ATOOLS::DDouble> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVVC vertex"; }

DECLARE_GETTER(VVVV_Calculator<ATOOLS::DDouble>,"XVVVV",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,VVVV_Calculator<ATOOLS::DDouble> >::
operator()(const Vertex_Key &key) const
{ return new VVVV_Calculator<ATOOLS::DDouble>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    VVVV_Calculator<ATOOLS::DDouble> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"VVVV vertex"; }
// ---- XPREC_END ----
