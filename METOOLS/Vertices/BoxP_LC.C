...
DECLARE_GETTER(BoxP_Calculator<long double>,"QBoxP4",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,BoxP_Calculator<long double> >::
operator()(const Vertex_Key &key) const
{ return new BoxP_Calculator<long double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    BoxP_Calculator<long double> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"BoxP vertex"; }
// ---- QPREC_END ----
// ---- XPREC_BEGIN: double-double instantiation ----
DECLARE_GETTER(BoxP_Calculator<ATOOLS::DDouble>,"XBoxP4",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,BoxP_Calculator<ATOOLS::DDouble> >::
operator()(const Vertex_Key &key) const
{ return new BoxP_Calculator<ATOOLS::DDouble>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    BoxP_Calculator<ATOOLS::DDouble> >::
PrintInfo(std::ostream &str,const size_t width) const
{ str<<"BoxP vertex"; }
// ---- XPREC_END ----
