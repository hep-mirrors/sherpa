...
[
  ...
  EXTRAXSINCS="-I\${EXTRAXSDIR}/Two2Two -I\${EXTRAXSDIR}/Model -I\${EXTRAXSDIR}/Main"
  EXTRAXSLIBS="-lExtraXS -lExtraXS2_2 -lExtraXSModel"
  AC_SUBST(EXTRAXSDIR)
  ...
  PDFLIBS="-lPDF -lDUPDF -lSudakov -lGRV -lRemnant"
  AC_SUBST(PDFDIR)
  AC_SUBST(PDFINCS)
  AC_SUBST(PDFLIBS)
