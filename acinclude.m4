...
[
  ...
  ANALYSISINCS="-I\${ANALYSISDIR}/Tools -I\${ANALYSISDIR}/Main -I\${ANALYSISDIR}/Detector -I\${ANALYSISDIR}/Triggers -I\${ANALYSISDIR}/Observables"
  ANALYSISLIBS="-L\${ANALYSISBUILDDIR}/Tools -L\${ANALYSISBUILDDIR}/Main -L\${ANALYSISBUILDDIR}/Detector -L\${ANALYSISBUILDDIR}/Triggers -L\${ANALYSISBUILDDIR}/Observables -lAnalysis -lAnalysisTools -lAnalysisDetector -lAnalysisTriggers -lObservables"
