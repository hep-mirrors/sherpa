...
[
  ...
  EXTRAXSINCS="-I\${EXTRAXSDIR}/BFKL -I\${EXTRAXSDIR}/Two2Two -I\${EXTRAXSDIR}/Main"
  EXTRAXSLIBS="-L\${EXTRAXSBUILDDIR}/BFKL -L\${EXTRAXSBUILDDIR}/Two2Two -L\${EXTRAXSBUILDDIR}/Main -lExtraXS -lExtraXS2_2 -lExtraXSBFKL"
  AC_SUBST(EXTRAXSDIR)
