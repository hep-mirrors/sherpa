...
CD_Parameter_Calculator_Getter::operator()(const String_Matrix &parameters,   
...
void CD_Parameter_Calculator_Getter::PrintInfo(std::ostream &str,const size_t width) const
{ 
  str<<"[list]"; 
}
