#include "Jet_Mass_and_Broadening.H"
...
void Heavy_Jet_Mass::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
...
void Light_Jet_Mass::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
...
void Jet_Mass_Difference::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
...
void Single_Inclusive_Jet_Mass::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
    p_histo->Insert(data->Get<JetMass_Broadening_Data>().heavyjetmass,weight,ncount);
...
void Wide_Jet_Broadening::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
...
void Narrow_Jet_Broadening::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
...
void Total_Jet_Broadening::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
...
void Jet_Broadening_Difference::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
    p_histo->Insert(data->Get<JetMass_Broadening_Data>().widejetbroadening-
...
void Single_Inclusive_Jet_Broadening::Evaluate(const ATOOLS::Blob_List & bl, double weight, int ncount)
{
  Blob_Data_Base * data = (*p_ana)[m_key];
  if (data) {
    p_histo->Insert(data->Get<JetMass_Broadening_Data>().widejetbroadening,weight,ncount);
