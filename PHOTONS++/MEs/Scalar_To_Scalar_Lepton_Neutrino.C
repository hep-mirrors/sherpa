...
double Scalar_To_Scalar_Lepton_Neutrino::SmodFull(unsigned int kk) {
...
double Scalar_To_Scalar_Lepton_Neutrino::Smod(unsigned int a, unsigned int b, unsigned int c) {
  return 0.;
}
...
Complex Scalar_To_Scalar_Lepton_Neutrino::InfraredSubtractedME_0_1(const int& ewmode) {
...
Complex Scalar_To_Scalar_Lepton_Neutrino::InfraredSubtractedME_1_05(unsigned int i, const double& xi) {
...
Complex Scalar_To_Scalar_Lepton_Neutrino::InfraredSubtractedME_1_15(unsigned int i, const double& xi) {
  return 0.;
}
...
double Scalar_To_Scalar_Lepton_Neutrino::GetBeta_0_1(const int& ewmode) {
  double sum = 0.;
  for (unsigned int i=0; i<=1; i++) {           // spin neutrino
    for (unsigned int j=0; j<=1; j++) {         // spin lepton
      for (unsigned int m=0; m<=0; m++) {       // spin FS scalar
...
void Scalar_To_Scalar_Lepton_Neutrino::Print_Info() {
  msg_Out() << " --------------------------- \n"
